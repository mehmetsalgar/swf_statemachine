...
import org.salgar.swf_statemachine.customersearch.configuration.orders_loading.action.ORDERS_LOADING___CUSTOMER_JOINED_OrdersLoaded_ProcessOrdersLoaded_action;
...
public class ORDERS_LOADING_CUSTOMER_JOINED_OrdersLoadedTransitionActionImpl {
    @Bean
    public ORDERS_LOADING___CUSTOMER_JOINED_OrdersLoaded_ProcessOrdersLoaded_action.IORDERS_LOADING_CUSTOMER_JOINED_OrdersLoaded_ProcessOrdersLoadedAction getORDERS_LOADING_CUSTOMER_JOINED_OrdersLoadedTransitionAction() {
        return new  ORDERS_LOADING___CUSTOMER_JOINED_OrdersLoaded_ProcessOrdersLoaded_action.IORDERS_LOADING_CUSTOMER_JOINED_OrdersLoaded_ProcessOrdersLoadedAction() {
            @Override
