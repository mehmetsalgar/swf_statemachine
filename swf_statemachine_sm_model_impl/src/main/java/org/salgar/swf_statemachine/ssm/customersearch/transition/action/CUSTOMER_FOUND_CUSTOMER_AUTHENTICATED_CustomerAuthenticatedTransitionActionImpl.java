...
import org.salgar.swf_statemachine.customersearch.configuration.customer_found.action.CUSTOMER_FOUND___CUSTOMER_AUTHENTICATED_CustomerFound_ProcessCustomerFound_action;
...
public class CUSTOMER_FOUND_CUSTOMER_AUTHENTICATED_CustomerAuthenticatedTransitionActionImpl {
    @Bean
    public CUSTOMER_FOUND___CUSTOMER_AUTHENTICATED_CustomerFound_ProcessCustomerFound_action.ICUSTOMER_FOUND_CUSTOMER_AUTHENTICATED_CustomerFound_ProcessCustomerFoundAction getICUSTOMER_FOUND_CUSTOMER_AUTHENTICATED_CustomerAuthenticatedTransitionAction() {
        return new CUSTOMER_FOUND___CUSTOMER_AUTHENTICATED_CustomerFound_ProcessCustomerFound_action.ICUSTOMER_FOUND_CUSTOMER_AUTHENTICATED_CustomerFound_ProcessCustomerFoundAction() {
            @Override
