...
import org.salgar.swf_statemachine.ssm.customersearchsm.configuration.customer_joined.action.CUSTOMER_JOINED___CUSTOMER_AUTHENTICATED_CustomerJoinedClicked_ProcessCustomerJoinRemoved_action;
...
public class CUSTOMER_JOINED_CUSTOMER_AUTHENTICATED_CustomerJoinRemovedTransitionActionImpl {
    @Bean
    public CUSTOMER_JOINED___CUSTOMER_AUTHENTICATED_CustomerJoinedClicked_ProcessCustomerJoinRemoved_action.ICUSTOMER_JOINED___CUSTOMER_AUTHENTICATED_CustomerJoinedClicked_ProcessCustomerJoinRemovedAction getCUSTOMER_JOINED_CUSTOMER_AUTHENTICATED_CustomerJoinRemovedTransitionAction() {
        return new CUSTOMER_JOINED___CUSTOMER_AUTHENTICATED_CustomerJoinedClicked_ProcessCustomerJoinRemoved_action.ICUSTOMER_JOINED___CUSTOMER_AUTHENTICATED_CustomerJoinedClicked_ProcessCustomerJoinRemovedAction() {
