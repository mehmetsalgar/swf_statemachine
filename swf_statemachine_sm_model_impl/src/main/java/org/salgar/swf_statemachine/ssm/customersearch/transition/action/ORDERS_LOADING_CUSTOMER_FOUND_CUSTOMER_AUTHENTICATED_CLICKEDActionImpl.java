...
import org.salgar.swf_statemachine.ssm.customersearchsm.configuration.orders_loading.action.ORDERS_LOADING___CUSTOMER_FOUND_CustomerAuthenticationFromOrdersLoadingRemoved_ProcessCustomerJoinRemoved_action;
...
public class ORDERS_LOADING_CUSTOMER_FOUND_CUSTOMER_AUTHENTICATED_CLICKEDActionImpl {
    @Bean
    public ORDERS_LOADING___CUSTOMER_FOUND_CustomerAuthenticationFromOrdersLoadingRemoved_ProcessCustomerJoinRemoved_action.IORDERS_LOADING___CUSTOMER_FOUND_CustomerAuthenticationFromOrdersLoadingRemoved_ProcessCustomerJoinRemovedAction getORDERS_LOADING_CUSTOMER_FOUND_CUSTOMER_AUTHENTICATED_CLICKEDAction() {
        return new ORDERS_LOADING___CUSTOMER_FOUND_CustomerAuthenticationFromOrdersLoadingRemoved_ProcessCustomerJoinRemoved_action.IORDERS_LOADING___CUSTOMER_FOUND_CustomerAuthenticationFromOrdersLoadingRemoved_ProcessCustomerJoinRemovedAction() {
            @Override
