...
import org.salgar.swf_statemachine.ssm.customersearchsm.configuration.customersearch_running.action.CUSTOMERSEARCH_RUNNING___CUSTOMER_FOUND_CustomerFound_ProcessCustomerFound_action;
...
public class CUSTOMERSEARCH_RUNNING_CUSTOMER_FOUND_CustomerFoundTransitionActionImpl {
    @Bean
    public CUSTOMERSEARCH_RUNNING___CUSTOMER_FOUND_CustomerFound_ProcessCustomerFound_action.ICUSTOMERSEARCH_RUNNING___CUSTOMER_FOUND_CustomerFound_ProcessCustomerFoundAction getCUSTOMERSEARCH_RUNNING_CUSTOMER_FOUND_CustomerFoundTransitionAction() {
        return new CUSTOMERSEARCH_RUNNING___CUSTOMER_FOUND_CustomerFound_ProcessCustomerFound_action.ICUSTOMERSEARCH_RUNNING___CUSTOMER_FOUND_CustomerFound_ProcessCustomerFoundAction() {
            @Override
